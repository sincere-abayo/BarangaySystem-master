                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input name="contact" type="text" maxlength="11" pattern="[0-9]{11}"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" id="report"
                                        value="<?= $view['narrative'] ?>" name="narrative"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <a type="button" href="staff_blotterreport.php" class="btn btn-danger" style="width: 135px;
                                border-radius: 30px;
                                font-size: 18px;
                                color:white;">Close</a>
