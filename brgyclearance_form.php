...
$resident = $resident->get_single_clearance($id_resident);
?>
<!DOCTYPE html>
<html id="clearance">
<style>
        ...
        <div style=" background: black;">
            ...
            <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">`
                ...
                <div class="col-xs-12 col-md-12">
                    <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE BARANGAY
                        CAPTAIN<br><br><b style="font-size: 25px;"><ins>BARANGAY CLEARANCE</ins></b></p> <br>
                    <p style="font-size: 18px;">TO WHOM IT MAY CONCERN:</p> <br>
                    <p style="text-indent:40px;text-align: justify;">This is to certify that
                        <b><?= $resident['lname']; ?>, <?= $resident['fname']; ?> <?= $resident['mi']; ?></b>,
                        <?= $resident['age']; ?> Years Old, <?= $resident['nationality']; ?> and a bonafide resident of
                    ...
                    <label style="font-size:18px;">____________</label> <label
                        style="font-size:18px;margin-left:4em;">VINCENT VILFAMAT</label><br>
                    <label style=" text-align: center;">Signature </label> <label
                        style=" text-align: center;margin-left:10em;">Punong Barangay</label>
