...
<html>
  <head> 
    ...
    border-radius: 20px; /* Gushyiraho impande zoroheje */
    margin-top: 5%; /* Gushyiraho intera hejuru ya button */
    margin-bottom: 8%; /* Gushyiraho intera hasi ya button */
    font-size: 25px; /* Umubare wa font ya button */
    letter-spacing: 2px; /* Gushyiraho intera hagati y'inyuguti */
    display: block; /* Gutuma button ifata umwanya wose */
    background-color: #3498db; /* Gushyiraho ibara rya button */
    color: white; /* Ibara ry'inyandiko kuri button */
    text-align: center; /* Gutuma inyandiko ziba hagati */
    border: none; /* Kwirinda imbibi ku button */
    cursor: pointer; /* Cursor iba pointer kuri button */
}
            }
            ...
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        ...
                        <h5>Certificate of Residency is one the Rwanda government issued identification documents 
                        ...
                        <div class="card-body">
                            <ul style="text-align: left; font-size: 16px;">
                                <p class="card-text">
                                    ...
                                    <li> Certify that you are living or residing in  Nyarutarama </li>
