    ...
    <title> Nyarutarama Management System </title>
      ...
      <script src="https://kit.fontawesome.com/67a9b7069e.js" crossorigin="anonymous"></script>
        ...
        <style>
           ...
           .applybutton {
    width: 100%; /* Button ifate 100% y'ubugari bwa container */
    height: 50px; /* Button ifate uburebure bwa 50px */
    border-radius: 20px; /* Impande zoroheje */
    margin-top: 5%; /* Intera iri hejuru ya button */
    margin-bottom: 8%; /* Intera iri hepfo ya button */
    font-size: 25px; /* Ingano y'inyuguti */
    letter-spacing: 2px; /* Intera hagati y'inyuguti */
    display: block; /* Buto ifata umwanya wose w’umurongo */
    background-color: #3498db; /* Ibara rya button (ubururu) */
    color: white; /* Ibara ry’inyuguti kuri button */
    text-align: center; /* Inyuguti zibaye hagati muri button */
    border: none; /* Ntizigere igira imbibi (border) */
    cursor: pointer; /* Umugereka (cursor) ugaragaza ko ari clickable */
    position: relative; /* Icyo twongeraho ngo izamurwe hejuru niba hari ibiyihisha */
    z-index: 100; /* Tuma iza hejuru y’ibindi bintu byose */
    transition: background-color 0.3s ease; /* Umwihariko wo guhindura ibara buhoro */
}

.applybutton:hover {
    background-color: #2980b9; /* Ibara rihinduka iyo uyerekejeho souris */
}
            ...
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        ...
                        All individuals visiting the Nyarutarama cell are required to register by filling out a Visitor’s Form. 
                <br> This helps maintain safety, proper documentation, and monitoring of entry and exit within the community. 
                        ...
                        <div class="modal-body">
                            <form method="post" class="was-validated">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="mi" class="mtop">Telephone </label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="bsname">ID NO:</label>
                                            <input name="bsname" type="text" class="form-control" placeholder="EnterID NO" required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="houseno"  placeholder="Enter First name." value="<?= $userdetails['houseno'];?>"  required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="street"  placeholder="Enter last name" value="<?= $userdetails['street'];?>"  required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="brgy"  placeholder="Enter telephone" value="<?= $userdetails['brgy'];?>"  required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label> ID NO: </label>
                                            <input type="text" class="form-control" name="municipal" placeholder="Enter id no" value="<?= $userdetails['municipal'];?>"  required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="">name of leader cell/vistor form:</label>
                                            <input type="form-control" name="bsindustry" id="status" placeholder="Enter names" required>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="" name="aoe" class="form-control" placeholder="Enter your AOE" required>
                                            <div class="valid-feedback">Valid.</div>
                                            <div class="invalid-feedback">Please fill out this field.</div>
                                        </div>
                                    </div>
