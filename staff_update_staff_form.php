                        ...
                        <div class="row" style="margin-top: 1.1em;">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="houseno" placeholder="Enter House No."
                                        value="<?= $staff['houseno']; ?>">
                                </div>
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="municipal"
                                        placeholder="Enter Municipality" value="<?= $staff['municipal'] ?>" required>
                                </div>
                            </div>
                        </div>
