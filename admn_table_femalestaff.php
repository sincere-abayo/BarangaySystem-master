...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col text-center">
            <h1> Nyarutarama Female Staff Table</h1>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <form method="POST" action="">
                ...
                <button class="btn btn-success"
                    ...
                    name="search_totalstaff">Search</button>
                <a href="admn_table_femalestaff.php" style="width: 90px; font-size: 18px; border-radius:30px;"
