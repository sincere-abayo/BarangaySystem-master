...
<body class="skin-black">
    ...
    <div class="col-xs-12 col-sm-5 col-md-8" style="background: white;  ">`
        ...
        <div class="pull-center" style="font-size: 16px;text-align: center;"><b>
                <image src="../BarangaySystem/icons/beverlylogo.png" ALIGN="left" style="width:150px;height:120px;">
                </image>
                <image src="../BarangaySystem/icons/beverlylogo.png" ALIGN="right" style="width:150px;height:120px;">
                </image>
                Republic of the Rwanda<br>
                Province of Kigali<br>
                Cell Nyarutarama<br>
                Tel. +2507826339667<br>
            </b>
        ...
        <div class="col-xs-12 col-sm-6 col-md-12" style="padding-left: 96px;padding-right: 96px;">
            <p class="text-center" style="font-size: 20px; font-size:bold;">z<br><br><b
                    style="font-size: 28px;"><ins>CERTIFICATE OF INDIGENCY</ins></b></p> <br><br><br>
            <p style="font-size: 18px; padding-left:3em;">TO WHOM IT MAY CONCERN:</p> <br><br>
            <p style="text-indent:40px;text-align: justify;">This is to certify that <b><?= $resident_data['lname']; ?>,
                    <?= $resident_data['fname']; ?> <?= $resident_data['mi']; ?></b>, of legal age,
                <?= $resident_data['nationality']; ?> and
                a bonifide resident at <?= $resident_data['houseno']; ?> <?= $resident_data['street']; ?>
                <?= $resident_data['brgy']; ?> <?= $resident_data['municipal']; ?>.
            </p><br>
            <p style="text-indent:40px;text-align: justify;">Further Certify that the above named subject is of good
                moral character and has
                good community standing, but unfortunately to the indigent family in this Cell.
            </p><br>
            <p style="text-indent:40px;text-align: justify;">This certification is issued upon the request of the above
                named party as a
                requirement needed for <b><ins><?= $resident_data['purpose']; ?></ins></b>.
            </p>
            ...
            <label style="font-size:17px;margin-left:70%;"><b> Mugabo cloude</b> </label><br>
            <label style=" text-align: center;margin-left:73%">chief cell/label>
