...
$auth->validate_admin();
$view = $resident->view_resident_household();
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col text-center">
            <h1> Nyarutarama Household Table </h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form method="POST" action="">
                ...
                <button class="btn btn-success" name="search_household"
                    style="width: 90px; font-size: 18px; border-radius:30px; margin-left:41.5%;">Search</button>
                <a href="admn_table_totalhouse.php" class="btn btn-info"
