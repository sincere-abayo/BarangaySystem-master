                ...
                <tr>
                    <td>
                        ...
                        <form action="" method="post">
                            <a href="update_resident_form_for_staff.php?id_resident=<?= $view['id_resident']; ?>"
                                style="width: 90px; font-size: 17px; border-radius:30px;" class="btn btn-primary"> Update </a>
