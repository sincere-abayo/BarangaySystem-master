...
<div class="container-fluid">
    ...
    <h1 class="mb-4 text-center">Nyarutarama Staff Data</h1>
    ...
    <div class="row">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header bg-primary text-white"> Add new Nyarutarama Staff </div>
                <div class="card-body">
                    <form method="post" class="was-validated">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control" name="contact" maxlength="11"
                                        pattern="[0-9]{11}" placeholder="Enter Contact Number" required>
                                    <div class="valid-feedback">Valid.</div>
                                    <div class="invalid-feedback">Please fill out this field.</div>
                                </div>
                            </div>
                        ...
                        <button class="btn btn-primary" type="submit" name="add_staff"
                            style="width: 150px; font-size: 18px; border-radius:30px; margin-left:40%;"> Submit
                        </button>
                    </form>
                </div>
            </div>
    ...
    <h1 class="mb-4 text-center">Nyarutarama Staff Tables</h1>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-hover text-center table-bordered table-responsive" id="dataTable" width="100%"
                cellspacing="0">
