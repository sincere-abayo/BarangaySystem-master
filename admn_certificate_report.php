...
$connection = $certificate_obj->openConn();
$sql = "SELECT * FROM tbl_rescert";
$params = [];
...
<div class="container-fluid">
    <h1 class="mb-4 text-center">Certificate Report</h1>
    <hr>
        ...
        <div class="card-body">
            <form method="POST" class="form-row align-items-end">
                ...
                <div class="form-group col-md-2">
                    ...
                    <a href="admn_certificate_report.php" class="btn btn-secondary btn-block mt-2">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="certTable">
...
<script>
    ...
    document.getElementById('exportPDF').addEventListener('click', function () {
        ...
        doc.text('Nyarutarama Certificate Report', doc.internal.pageSize.getWidth() / 2, 18, { align: 'center' });
