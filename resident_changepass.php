...
<body>
    ...
    <nav class="navbar navbar-dark bg-primary sticky-top">
        ...
        <a href="#down1" data-toggle="tooltip" title="Change Password" class="btn5 bg-primary"><i
                class="fa fa-user-lock fa-lg"></i></a>
        <a href="#down" data-toggle="tooltip" title="Contact" class="btn4 bg-primary"><i
                ...
                <div class="row margin mtop">
                    ...
                    <div class="col-6">
                        <div class="card mbottom">
                            <div class="card-header bg-primary text-white text-center" style="font-size:30px"> Change
                                Password </div>
                            <br>
                                    ...
                                    <div class="col">
                                        <form method="post">
                                            ...
                                            <div class="input-container">
                                                ...
                                                <input class="input-field" type="password" id="password-field"
                                                    name="oldpassword password" placeholder="Enter Current Password"
                                                    require>
                                                <input class="input-field" type="hidden" id="password-field"
                                                    name="oldpasswordverify password"
                                            ...
                                            <div class="input-container">
                                                ...
                                                <input class="input-field" id="password1" type="password"
                                                    name="password1 newpassword" placeholder="Enter New Password"
                                                    require>
                                            </div>
                                            ...
                                            <div class="input-container">
                                                ...
                                                <input class="input-field" id="confirm_password" type="password"
                                                    name="checkpassword confirm_password"
                                                    placeholder="Enter Verify Password" require>
                                            </div>
                                            ...
                                            <button class="btn2 btn-primary" type="submit" name="resident_changepass">
