...
$resident = $resident->get_single_brgyid($id_resident);
?>
<!DOCTYPE html>
<html id="clearance">
<style>
  ...
  <div class="col-xs-12 col-sm-5 col-md-8">`
    ...
    <div class="container" style="margin-left: 2em;">
      ...
      <div class="centered">
        ...
        <label style="position:relative; left:65px;  font-size:15px;color:white"> <b><?= $resident['houseno']; ?>
            <?= $resident['street']; ?> <?= $resident['brgy']; ?> <?= $resident['municipal']; ?> </b> </label>
      </div>
      <div class="bottom-left">
        <label style="position:relative; left:170px; bottom:30px; font-size:15px; color:white">
          <b><?= $resident['bdate']; ?></b> </label>
        <label style="position:relative; left:190px; bottom:30px; font-size:15px; color:white">
          <b><?= $resident['bplace']; ?></b> </label>
    ...
    <div class="container" style="margin-left: 2em;">
      ...
      <div class="top-left">
        <label style="position:relative; left:160px; top:30px; font-size:12px;color:white">
          <?= $resident['inc_lname']; ?>, <?= $resident['inc_fname']; ?> <?= $resident['inc_mi']; ?> </label>
        <label style="position:relative; left:-13px; top:45px; font-size:12px;color:white">
          <b><b><?= $resident['inc_houseno']; ?> <?= $resident['inc_street']; ?> <?= $resident['inc_brgy']; ?> </b>
        </label>
        <label style="position:relative; left:-218px; top:65px; font-size:12px;color:white">
          <b><?= $resident['inc_contact']; ?></b> </label>
      </div>

      <div class="bbottom-left">
        <label style="position:absolute; left:1px; bottom:20px; font-size:15px; color:white"> <b>01/14/2021 </b>
        </label>
        <label style="position:absolute; left:160px; bottom:20px; font-size:15px; color:white"> <b>01/14/2022 </b>
        </label>
      </div>
    </div>
