...
$residents = $resident_obj->view_resident();
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="UTF-8">
    <title>Staff Resident Report</title>
...
<body>
    <div class="container mt-4">
        <h2 class="mb-4">Resident Report</h2>
        ...
        <div class="mb-3">
            <strong>Total Residents:</strong> <span
                id="totalResidents"><?= is_array($residents) ? count($residents) : 0 ?></span>
        </div>
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped" id="residentTable">
    ...
    <script>
        ...
        function filterTable() {
            ...
            totalResidents.textContent = count;
        }
        [searchInput, filterYear, filterMonth, filterStart, filterEnd].forEach(el => el.addEventListener('input',
            filterTable));
        ...
        function exportPDF() {
            ...
            doc.text('Resident Report', 14, 16);
            doc.autoTable({
                html: '#residentTable',
                startY: 22,
                headStyles: {
