...
$certificate->create_brgyclearance();
$requests = $certificate->view_brgyclearance_by_resident($userdetails['id_resident']);
?>
...
<head>
    ...
    <title>Nyarutarama Cell Clearance Form</title>
...
<body>
    ...
    <div class="container-fluid container1">
        <div class="row justify-content-center">
            <div class="col text-center">
                <div class="header">
                    <h1 class="text1">Nyarutarama Cell Clearance</h1>
                    <h5>
                        A Nyarutarama Cell Clearance is an official document certifying that the applicant is of good
                        moral character and a
                        law-abiding citizen of the Nyarutarama cell.<br>
                        It is often required for employment, business, or other legal purposes.
                    </h5>
                </div>
                <br>
            </div>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <p>Your request will be reviewed and approved by the Nyarutarama cell.</p>
            </div>
            <div class="col">
                <i class="fas fa-file fa-7x"></i>
                <br><br>
                <h3>Step 4: Release</h3>
                <p>Claim your Nyarutarama Cell Clearance once approved.</p>
            </div>
        </div>
    </div>
                ...
                <div class="card bg-primary card1 text-white">
                    ...
                    <div class="card-body">
                        <ul style="text-align: left; font-size: 16px;">
                            <li> Must be a resident of the Nyarutarama cell. </li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle">Nyarutarama Cell Clearance Form</h5>
                    ...
                    <div class="modal-body">
                        <form method="post" class="was-validated" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="brgy">Nyarutarama Cell:</label>
                                        <input name="brgy" type="text" class="form-control"
                                            placeholder="Enter Nyarutarama Cell"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="status" type="text" class="form-control"
                                            ...
                                            value="<?= htmlspecialchars($userdetails['status'] ?? '') ?>" required>
                                        <div class="valid-feedback">Valid.</div>
                                        <div class="invalid-feedback">Please fill out this field.</div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" name="create_brgyclearance" class="btn btn-primary">Submit
                                    Request</button>
                            </div>
                        </form>
                    </div>
    ...
    <div class="container mt-5">
        <h2 class="text-center">Your Nyarutarama Cell Clearance Requests</h2>
        <?php if (empty($requests)): ?>
        <div class="alert alert-info text-center" role="alert">You have not submitted any Nyarutarama Cell Clearance
            requests
            yet.
        </div>
        <?php endif; ?>
