...
<html>
  <head> 
    <title> Nyarutarma Management System </title>
    ...
    <body>
        ...
        <div class="container-fluid container1"> 
            <div class="row"> 
                <div class="col"> 
                    <div class="header">
                        <h1 class="text1">Nyarutarama Clearance </h1>
                        <h5> Nyarutarama Clearance is a document issued by the Nyarutarama Secretary and signed by the 
                        <br>Nyarutarama Captain stating that you are a living at that specific place and you are 
            ...
            <div class="row text2">
                ...
                <div class="col">
                    <div class="card bg-primary card2">
                        ...
                        <div class="card-body">
                            <ul style="text-align: left; font-size: 16px;">
                                <p class="card-text">
                                    <li> Valid for Six (6) Months. Not valid without Nyarutarama dry seal </li>
                                </p>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col">
                    <div class="card bg-primary card5">
                        <div class="card-header">
                            <h6> Reason to get a Nyarutarama Clearance<br><br> <i class="fas fa-file fa-2x"></i>  </h6>
                        </div>
                        <div class="card-body">
                            <ul style="text-align: left; font-size: 16px;">
                                <p class="card-text">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle">Nyarutarama CLearance Form</h5>
