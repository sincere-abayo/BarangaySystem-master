            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" class="was-validated">
                        ...
                        <button class="btn btn-primary" type="submit" name="add_resident"
                            style="width: 140px; font-size: 15px; border-radius:30px; margin-left:40%;"> Submit
                        </button>
                    </form>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <form method="POST" action="">
            <div class="input-icons">
                ...
                <input type="search" class="form-control search" name="keyword" style="border-radius: 30px;" value=""
                    required="" />
            </div>
            <button class="btn btn-success" name="search_resident"
                style="width: 90px; font-size: 17px; border-radius:30px; margin-left:41.5%;">Search</button>
            <a href="staff_resident_crud.php" class="btn btn-info"
