    ...
    <div class="col-xs-12 col-sm-6 col-md-8">
        <div style=" background: black;">
            <div class="col-xs-4 col-sm-6 col-md-3"
                style="background: white; margin-right:10px; border: 2px solid black;">
                <center>
                    <image src="../BarangaySystem/icons/beverlylogo.png" style="width:90%;height:164px;" />
                </center>
                <div style="margin-top:20px; text-align: center; word-wrap: break-word;">

                    <p style="margin-top: 2em;">
                        <b>Vincent HABIMANA</b><br>
                        <span style="font-size:12px;">HEAD OF CELL</span>
                    </p><br>
                    <p>
            ...
            <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">`
                ...
                <div class="col-xs-12 col-md-12">
                    <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE Nyarutarama<br><br><b
                            style="font-size: 25px;"><ins>CERTIFICATE OF RESIDENCY</ins></b></p> <br>
                    ...
                    <p style="text-indent:40px;text-align: justify;">This certification is issued upon the request of
                        ...
                        as a supporting document needed for <ins><?= $resident_data['purpose']; ?></ins>.</p> <br>
                    ...
                    <label style="font-size:18px;">____________</label> <label
                        style="font-size:18px;margin-left:4em;">VINCENT HABIMANA</label><br>
                    <label style=" text-align: center;">Signature </label> <label
                        style=" text-align: center;margin-left:10em;">chief leader Nyarutarama</label>
            ...
            <div class="col-xs-8 col-md-4" style="margin-top: 7em;">
                <b style="font-size:18px;">Rest. Cert. No. <u> <?= $resident_data['id_rescert'] ?> </u><br>
                    ...
                    <span style=" text-align: center;">Issued on <u><?= $resident_data['date'] ?></span></u></b>
            </div>
