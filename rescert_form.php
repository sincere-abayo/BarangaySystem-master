            ...
            <div style=" background: black;" >
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">`
                    ...
                    <div class="col-xs-12 col-md-12">
                        <p class="text-center" style="font-size: 20px; font-size:bold;">OFFICE OF THE Nyarutarama<br><br><b style="font-size: 25px;"><ins>CERTIFICATE OF RESIDENCY</ins></b></p> <br>
                        ...
                        <p style="text-indent:40px;text-align: justify;">Issued this <?= $resident['date'];?> Kigali City. </p>
                        ...
                        <label style="font-size:18px;">____________</label>    <label style="font-size:18px;margin-left:4em;">VINCENT HABIMANA</label><br> 
                        <label style=" text-align: center;">Signature </label>     <label style=" text-align: center;margin-left:10em;">chief leader Nyarutarama</label>
