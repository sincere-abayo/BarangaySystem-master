                        ...
                        <form method="post" class="was-validated" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <br>
                                    <img class="idpicture" id="blah" src="http://placehold.it/200x200"
                                        alt="your image" />
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="lname">Last Name:</label>
                                        <input name="inc_lname" type="text" class="form-control"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="fname">First Name:</label>
                                        <input name="inc_fname" type="text" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="mi" class="mtop">Middle Name </label>
                                        <input name="inc_mi" type="text" class="form-control"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input name="inc_contact" type="text" maxlength="11" class="form-control"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        <label> House No: </label>
                                        <input type="text" class="form-control" name="inc_houseno"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label> Street: </label>
                                        <input type="text" class="form-control" name="inc_street"
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label> Municipality: </label>
                                        <input type="text" class="form-control" name="inc_municipal"
