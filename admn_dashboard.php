...
$rescountvoter = $resident->count_voters();
$rescountsenior = $resident->count_resident_senior();

$staffcount = $staff->count_staff();
$staffcountm = $staff->count_mstaff();
$staffcountf = $staff->count_fstaff();
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-4">
            <h4> Nyarutarama Residents Data </h4>
            <br>
            ...
            <div class="card border-left-info shadow card-upper-space">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Total Nyarutarama Female Staffs</div>
