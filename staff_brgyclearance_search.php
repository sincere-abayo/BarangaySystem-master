                    ...
                    <td>
                        <form action="" method="post">
                            <a class="btn btn-primary" style="width: 90px; font-size: 17px; border-radius:30px;"
                                href="brgyclearance_form.php?id_resident=<?= $view['id_resident']; ?>">Generate</a>
            ...
            <?php if (is_array($view)) { ?>
                <?php foreach ($view as $view) { ?>
                    ...
                    <tr>
                        <td>
                            <form action="" method="post">
                                <a class="btn btn-primary" style="width: 90px; font-size: 17px; border-radius:30px;" target="blank"
                                    href="brgyclearance_form.php?id_clearance=<?= $view['id_clearance']; ?>">Generate</a>
                                <input type="hidden" name="id_rescert" value="<?= $view['id_rescert']; ?>">
                            </form>
                        </td>
                        <td> <?= $view['id_resident']; ?> </td>
