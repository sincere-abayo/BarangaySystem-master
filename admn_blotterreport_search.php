    ...
    <tbody>
        ...
        <tr>
            <td>
                <form action="" method="post">
                    <a class="btn btn-success"
                        ...
                        href="update_blotter_form.php?id_blotter=<?= $view['id_blotter']; ?>">Update</a>
                    ...
                    <button class="btn btn-danger" style="width: 90px; font-size: 17px; border-radius:30px;"
                        type="submit" name="delete_blotter"> Archive </button>
                </form>
            </td>
            ...
            <td>
                ...
                <img src="data:image/jpeg;base64,<?= base64_encode($view['blot_photo']) ?>" alt="Blotter Photo"
