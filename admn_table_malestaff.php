...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col text-center">
            <h1> Nyarutarama Male Staff Table</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form method="POST">
                ...
                <button class="btn btn-success" name="search_totalstaff"
                    style="width: 90px; font-size: 18px; border-radius:30px; margin-left:41.5%;">Search</button>
                <a href="admn_table_maleres.php" class="btn btn-info"
