...
$certificate->delete_clearance();
$view = $certificate->view_clearance();
$id_resident = $_GET['id_resident'];
$resident_data = $certificate->get_single_clearance($id_resident);
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col text-center">
            <h1> Nyarutarama Clearance Requests</h1>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col">
            <form method="POST">
                ...
                <button class="btn btn-success" name="search_clearance"
                    style="width: 90px; font-size: 18px; border-radius:30px; margin-left:41.5%;">Search</button>
                <a href="admn_brgyclearance.php" class="btn btn-info"
