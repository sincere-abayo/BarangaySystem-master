...
// DB Connection & Filtering
$connection = $staff_obj->openConn();
...
<div class="container-fluid">
    <h1 class="mb-4 text-center">Staff Report</h1>
    <hr>
            ...
            <form method="POST" class="form-row align-items-end">
                <div class="form-group col-md-3">
                    ...
                    <select class="form-control" id="filter_type" name="filter_type">
                        ...
                        <option value="annually" <?= $filter_type_val == 'annually' ? 'selected' : '' ?>>Annually
                        </option>
                ...
                <div class="form-group col-md-2">
                    ...
                    <a href="admn_staff_report.php" class="btn btn-secondary btn-block mt-2">Reset</a>
                </div>
            </form>
        </div>
    </div>
...
document.getElementById('exportPDF').addEventListener('click', function() {
    ...
    doc.text('Nyarutarama Staff Report', doc.internal.pageSize.getWidth() / 2, 18, {
        align: 'center'
    });

    doc.setFontSize(12);
    doc.setFont('helvetica', 'normal');
    doc.text(filterSummary, doc.internal.pageSize.getWidth() / 2, 26, {
        align: 'center'
    });
    ...
    doc.autoTable({
        ...
        didDrawPage: function(data) {
            ...
            doc.line(data.settings.margin.left, pageHeight - 16, pageWidth - data.settings.margin
                .right, pageHeight - 16);
            doc.setFontSize(10);
            doc.setTextColor(100);
            doc.text('Generated by Nyarutarama Management System', data.settings.margin.left,
                pageHeight - 10);
            const pageNum = 'Page ' + doc.internal.getNumberOfPages();
            doc.text(pageNum, pageWidth - data.settings.margin.right, pageHeight - 10, {
                align: 'right'
            });
        }
    });
