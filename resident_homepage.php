...
// Get unread notifications for the resident
$unread_notifications = [];
if (!empty($userdetails['id_resident'])) {
    $unread_notifications = $notification->getUnreadNotifications($userdetails['id_resident']);
}
                ...
                <div class="col-lg-8">
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        <h5 class="alert-heading">
                            <i class="fas fa-bell"></i> You have <?= count($unread_notifications) ?> new notification(s)
                        </h5>
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div>
                                            ...
                                            <small class="text-muted">
                                                ...
                                                <?= date('M j, Y g:i A', strtotime($notif['created_date'])) ?>
                                            </small>
                                        </div>
                        ...
                        <div class="zoom1">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <img src="icons/ResidentHomepage/busper.png" alt="Business Permit"
                                            class="img-fluid" style="max-height: 60px;">
                                    </div>
                                    <h5 class="card-title text-dark mb-0">Business Permit</h5>
                                    <small class="text-muted">Apply for business permits</small>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="services_certofindigency.php?id_resident=<?= $userdetails['id_resident']; ?>"
                        ...
                        <div class="zoom1">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <img src="icons/ResidentHomepage/indigency.png" alt="Certificate of Indigency"
                                            class="img-fluid" style="max-height: 60px;">
                                    </div>
                                    <h5 class="card-title text-dark mb-0">Certificate of Indigency</h5>
                                    <small class="text-muted">Request indigency certificate</small>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="services_certofres.php?id_resident=<?= $userdetails['id_resident']; ?>"
                        ...
                        <div class="zoom1">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <img src="icons/ResidentHomepage/residency.png" alt="Certificate of Residency"
                                            class="img-fluid" style="max-height: 60px;">
                                    </div>
                                    <h5 class="card-title text-dark mb-0">Certificate of Residency</h5>
                                    <small class="text-muted">Request residency certificate</small>
                                </div>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="services_brgyclearance.php?id_resident=<?= $userdetails['id_resident']; ?>"
                        ...
                        <div class="zoom1">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <img src="icons/ResidentHomepage/clearance.png" alt="Nyarutarama Clearance"
                                            class="img-fluid" style="max-height: 60px;">
                                    </div>
                    ...
                    <a href="services_blotter.php?id_resident=<?= $userdetails['id_resident']; ?>"
                        ...
                        <div class="zoom1">
                            <div class="card h-100 shadow-sm border-0">
                                <div class="card-body text-center p-4">
                                    <div class="mb-3">
                                        <img src="icons/ResidentHomepage/complain.png" alt="Peace and Order"
                                            class="img-fluid" style="max-height: 60px;">
                                    </div>
                                    <h5 class="card-title text-dark mb-0">Peace and Order</h5>
                                    <small class="text-muted">Report incidents and complaints</small>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            alert('Error marking notification as read: ' + response.message);
                        }
                    },
                    error: function () {
                        button.prop('disabled', false).text('Mark as Read');
