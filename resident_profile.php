...
<body>
    ...
    <nav class="navbar navbar-dark bg-primary sticky-top">
        ...
        <a href="#down2" data-toggle="tooltip" title="View Information" class="btn6 bg-primary"><i
                class="fa fa-user-circle fa-lg"></i></a>
        <a href="#down1" data-toggle="tooltip" title="Update Information" class="btn5 bg-primary"><i
                class="fa fa-user-edit fa-lg"></i></a>
                        ...
                        <div class="col-xl-12">
                            <div class="form-inline">
                                ...
                                <button class="btn btn-primary" style="margin-left: .2%; width:143px;" type="submit"
                                    name="profile_update"> Update </button>
            ...
            <div class="row">
                ...
                <div class="col-md-3 mx-auto shfooter">
                    ...
                    <ul class="list-unstyled collapse" id="Documentation">
                        ...
                        <li><a class="footerlinks" href="services_brgyclearance.php">Nyaruratama Clearance</a></li>
